...
from utils import config_reader, report_generator
...
async def run(stock_ticker):
    ...
    output_folder = config_reader.get_value_by_name(
        config_data, "assistants", "structured_report_generator", "output_folder"
    )
    ...
    consolidated_report = await structured_report_generator.get_consolidated_report(
