...
class NewsAnalyst:
    ...
    async def get_news_report(self, stock_ticker):
        ...
        print(
            f"ChatCompletion News Client Attributes: {chat_completion.__dict__}",
            flush=True,
        )
...
class FinancialAnalyst:
    ...
    async def get_financial_report(self, stock_ticker, report_type, report_metrics):
        ...
        **MAKE SURE** to calculate matrics for all date periods provided
        ...
        kernel.add_service(chat_completion)
        chat_completion_service_by_type = kernel.get_service(
            type=ChatCompletionClientBase
        )
        print(
            f"Chat Completion FinancialAnalyst Client Details: {chat_completion_service_by_type}",
            flush=True,
        )
        print(
...
class StructuredReportGenerator:
    ...
    async def get_consolidated_report(
        ...
        print(
            f"Chat Completion StructuredReport Client Details:{chat_completion_service_by_type}",
            flush=True,
        )
        print(
